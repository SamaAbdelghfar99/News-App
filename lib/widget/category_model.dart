...
class CategoryModel {
 ...
 static List<CategoryModel> getCategory(){
   return [
     ...
     CategoryModel(id: 'entertainment', name: 'Entertainment', image: 'assets/images/Politics.png', color: Color(0xff003E90)),
     CategoryModel(id: 'health', name: 'Health', image: 'assets/images/health.png', color: Color(0xffED1E79)),
     CategoryModel(id: 'technology', name: 'Technology', image: 'assets/images/environment.png', color: Color(0xff4882CF)),
     CategoryModel(id: 'science', name: 'Science', image: 'assets/images/science.png', color: Color(0xffF2D352)),
     CategoryModel(id: 'general', name: 'General', image: 'assets/images/Politics.png', color:Colors.green),
   ];
 }
}
